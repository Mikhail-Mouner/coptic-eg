                    ...
                    <div class="card overflow-hidden">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center p-3">
                                ...
                                <div class="img">
                                    <img src="{{ asset('back-end/images/error-img.png') }}" class="img-fluid" alt="">
                                </div>
                                ...
                                <a class="btn btn-primary mb-4 waves-effect waves-light" href="{{ route('home') }}"><i class="mdi mdi-home"></i> Back to Home Page</a>
                            </div>
